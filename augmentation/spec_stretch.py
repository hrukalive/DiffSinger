...
class SpectrogramStretchAugmentation(BaseAugmentation):
    ...
    def __init__(self, config: dict, data_dirs: list, augmentation_args: dict, pe: BasePE = None):
    ...
    def process_item(self, item: dict, key_shift=0., speed=1., replace_spk_id=None) -> dict:
        ...
        mel = get_mel_torch(
            ...
            fmin=self.config['fmin'], fmax=self.config['fmax'], mel_base=self.config['mel_base'],
